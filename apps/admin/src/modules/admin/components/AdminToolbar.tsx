...
export const adminToolbarButtonClass =
  'min-h-10 shrink-0 self-end rounded-xl px-3.5 text-[14px] shadow-sm';
  ...
  return (
    ...
    >
      <div className='flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-6'>
        <div className='min-w-0 lg:basis-[360px] xl:basis-[420px] lg:shrink-0'>
        ...
        <div className='flex min-w-0 flex-1 flex-wrap items-end gap-2 lg:flex-nowrap lg:justify-start xl:justify-end'>
          {children}
        </div>
      </div>
    </section>
