  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative z-10 grid max-h-[min(90dvh,940px)] w-full max-w-4xl grid-rows-[auto_minmax(0,1fr)_auto] overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-[0_24px_54px_-38px_rgba(15,23,42,0.32)] animate-zoom-in",
          panelClassName,
        )}
...
export function ModalBody({ className, children }: ModalSectionProps) {
  return (
    <div
      className={cn(
        "admin-scrollbar min-h-0 overflow-x-hidden overflow-y-auto bg-white px-5 py-5 sm:px-6 sm:py-6",
        className,
      )}
    >
      {children}
