...
export function Dropdown({
  ...
  const updatePortalPosition = useCallback(() => {
    ...
    setPortalStyle({
      ...
      bottom: shouldOpenAbove ? window.innerHeight - rect.top + offset : undefined,
      left,
      ...
      {portal && open && typeof document !== 'undefined'
        ? createPortal(
            <div
              ...
              style={portalStyle}
              className={cn(
                'overflow-hidden rounded-[16px] border border-slate-200 bg-white shadow-[var(--admin-shadow-floating)] transition-all duration-150 ease-out',
